...
pub struct WebViewAttributes<'a> {
  ...
  /// On Linux, it is recommended to use GTK's own layout capabilities to size and position the webview.
...
impl<'a> WebViewBuilder<'a> {
  ...
  /// # Platform-specific:
  ///
  /// - **Linux**: Not supported, use [`WebViewBuilderExtUnix::new_gtk`] instead.
...
pub trait WebViewBuilderExtUnix<'a> {
  ...
  ///
  /// - If the container is [`gtk::Window`], it is added using [`Window::set_child(Some(webview))`](gtk::prelude::GtkWindowExt::set_child).
  /// - If the container is [`gtk::Box`], it is added using [`Box::append(webview)`](gtk::prelude::BoxExt::append)
  ///   with the webview's [`vexpand`](gtk::prelude::WidgetExt::set_vexpand) and [`hexpand`](gtk::prelude::WidgetExt::set_hexpand) set to true.
  /// - Other containers are not supported and will return an error.
  ///
  /// # Panics:
  ///
...
impl WebView {
  ...
  /// # Platform-specific:
  ///
  /// - **Linux**: Not supported, use [`WebViewExtUnix::new_gtk`] instead.
